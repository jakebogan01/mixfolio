...
<div class="w-full max-w-md rounded-xl bg-white shadow-xl ring-1 ring-black/10">
	<form class="p-7 sm:p-11" use:form>
		...
		<button
			...
			class="inline-flex w-full cursor-pointer py-5 items-center justify-center rounded-full border border-transparent bg-blue-500 px-4 py-[calc(--spacing(2)-1px)] text-base font-medium whitespace-nowrap text-white shadow-md data-disabled:bg-gray-950 data-disabled:opacity-40 sm:transition-colors sm:hover:bg-gray-900/75"
			id="btn">
			<svg class="mr-2 -ml-1 w-4 h-4" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512"><path fill="currentColor" d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 123 24.5 166.3 64.9l-67.5 64.9C258.5 52.6 94.3 116.6 94.3 256c0 86.5 69.1 156.6 153.7 156.6 98.2 0 135-70.4 140.8-106.9H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z"></path></svg>{btnText} with Google
		</button>
		</div>
		<div class="mt-3">
			<button
				...
				class="inline-flex w-full cursor-pointer py-5 items-center justify-center rounded-full border border-transparent bg-green-600 px-4 py-[calc(--spacing(2)-1px)] text-base font-medium whitespace-nowrap text-white shadow-md data-disabled:bg-gray-950 data-disabled:opacity-40 sm:transition-colors sm:hover:bg-gray-900/75"
				id="btn2">
