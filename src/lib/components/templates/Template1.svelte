					...
					{#each data?.expand?.testimonials as testimonial, i (testimonial?.id)}
						<div class="mb-10 w-full lg:mb-0">
							...
							>
								...
								can confidently say that their expertise and professionalism exceeded my
								expectations.
							</p>
							<h6
							...
							<div class="flex items-center gap-4">
								...
								/>
								<div class="bg-blue-gray-100 h-[36px] w-[1px]"></div>
								<img
									src="https://demos.creative-tim.com/material-tailwind-dashboard-react/img/home-decor-1.jpeg"
									alt="spotify"
									class="relative inline-block h-9 w-9 cursor-pointer rounded-md object-cover object-center opacity-100"
								/>
								<div class="bg-blue-gray-100 h-[36px] w-[1px]"></div>
								<img
									src="https://demos.creative-tim.com/material-tailwind-dashboard-react/img/home-decor-1.jpeg"
